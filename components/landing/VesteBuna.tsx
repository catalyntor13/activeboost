...
export default function VesteBuna() {
    return (
        ...
        <div className="max-w-6xl flex flex-col items-center mx-auto text-center gap-6">
            <h1 className="text-[#7dc142] text-center font-bold text-xs uppercase tracking-widest mb-2">Vestea bună</h1>
          <h2 className="text-center text-4xl font-bold text-slate-950  uppercase tracking-tighter ">Toate au o singură cauză</h2>
           <p className="text-gray-400">Nu e vina ta. E biologie.</p>

           <div className="text-[#7dc142]"><FaArrowDown/></div>
           ...
           <p className="text-gray-500 max-w-2xl">Când glicemia urcă și cade brusc, corpul răspunde cu oboseală, foame, pofte și acumulare de grăsime. Dacă înveți să controlezi asta, controlezi totul.</p>
        </div>
