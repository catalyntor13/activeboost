...
const PovesteaMea = () => {
  return (
    ...
    <div className="lg:max-w-6xl p-4 lg:p-0 lg:mx-auto">
      ...
      <div className="text-center font-bold text-2xl lg:text-4xl mb-10 mt-5 text-[#4b4c4b] font-jakarta">
        <h1>Povestea Mea:</h1>
   ...
   <div className="flex flex-col lg:flex-row sm:flex-row items-center justify-center gap-10 mb-10">
    ...
    <div className="lg:w-lg font-sans text-[#4b4c4b] ">
...
<p className="text-[18px]  tracking-tight mb-5">Până într-o zi, când, aproape renunțând la idee, am dat peste munca unui biochimist francez și am înțeles <span className="text-green-500 font-semibold">adevărata</span> cauză a problemelor mele.</p>
...
<p className="text-[18px]  mb-5 tracking-tight">De aceea am creat acest ghid. Am simplificat informații bazate pe <span className="text-green-500 font-semibold">ani de cercetare științifică</span> în pași pe care i-am <span className="text-green-500 font-semibold"></span>testat personal și pe care oricine îi poate aplica. </p>
<p className="text-[18px] text-green-500 font-semibold tracking-tight">Dacă eu am putut, sunt convins că poți și tu..</p>
    </div>
    <div>
