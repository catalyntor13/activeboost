...
<p className="text-xl lg:text-2xl tracking-tight">Acesta nu este o altă dietă complicată. Este un <span className="text-green-500 font-semibold">set de "unelte"</span> practice pe care le poți folosi începând de azi pentru a prelua controlul asupra energiei, a greutății și a poftelor tale, mâncând în continuare alimente delicioase.</p>
    ...
    <p>
        ...
        <li className="flex items-start gap-2 tracking-tight" >
            <FaCheckSquare className="text-green-400 text-xl flex-none mt-1" /> 
          <p><span className="font-bold">DE CE MICUL TĂU DEJUN "SĂNĂTOS"</span> (cu cereale și suc de fructe) îți sabotează de fapt întreaga zi și ce să mănânci în schimb pentru energie constantă.</p>
          </li>
      ...
      <div className="bg-[#eef3ed] border-solid border-1 rounded-md shadow-md border-[#444444] p-5 m-4">
        ...
        <ul className="space-y-5 p-5">
          ...
          <li className="flex items-start gap-1">
            ...
            <p className="text-xl"> 
              <span className="font-semibold">...te-ai săturat să te simți obosit și fără vlagă</span> după fiecare masă și cauți o sursă de energie naturală și constantă.</p>
           </li>
          <li className="flex items-start gap-1">
            <FaCheckCircle className="text-green-600 flex-none mt-1 text-xl" />
            <p className="text-xl"><span className="font-semibold">...iubești mâncarea și urăști dietele restrictive,</span> dar vrei să găsești o cale de a te bucura de alimentele preferate fără vinovăție și fără kilograme în plus.</p>
            </li>
          <li className="flex items-start gap-1">
            <FaCheckCircle className="text-green-600 flex-none mt-1 text-xl" />
            <p className="text-xl"><span className="font-semibold">...ești o persoană ocupată </span>, un părinte sau un profesionist, și ai nevoie de soluții simple și rapide, nu de reguli complicate care îți consumă tot timpul.</p>
            </li>
          <li className="flex items-start gap-1">
            <FaCheckCircle className="text-green-600 flex-none mt-1 text-xl" />
            <p className="text-xl"><span className="font-semibold">...vrei să înțelegi în sfârșit semnalele pe care ți le transmite corpul tău </span> și să înveți cum să lucrezi cu el, nu împotriva lui.</p>
            </li>
          <li className="flex items-start gap-1">
            <FaCheckCircle className="text-green-600 flex-none mt-1 text-xl" />

            <p className="text-xl"><span className="font-semibold">...ești gata să renunți la soluțiile 'minune' care eșuează pe termen lung</span> și să adopți un stil de viață sustenabil, care îți aduce rezultate reale.</p>
            </li>
        </ul>
      </div>
    </div>
