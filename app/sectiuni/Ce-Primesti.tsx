...
const CePrimesti = () => {
  return (
    <div className="lg:w-6xl  lg:mx-auto ">
      <h1 className='text-center lg:text-4xl text-2xl font-semibold my-10 font-jakarta'>Ce Primești Imediat ce Comanzi:</h1>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 justify-items-center gap-10'>
        ...
        <div className="text-center space-y-2 font-sans text-[#4b4c4b] ">
