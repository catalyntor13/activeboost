...
const CePrimesti = () => {
  return (
    <div className="lg:w-6xl  lg:mx-auto ">
      <h1 className='text-center lg:text-4xl text-2xl font-semibold my-10'>Ce Primești Imediat ce Comanzi:</h1>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 justify-items-center gap-10'>
        ...
        <div className="text-center space-y-2">
            ...
            <p className="text-3xl font-bold text-green-500">"10 Hack-uri Simple Pentru o Glicemie Stabilă"</p>
        ...
        <div className="text-center space-y-2">
           <h2 className="text-3xl font-bold">BONUS GRATUIT:</h2>
            <p className="text-3xl font-bold">Mini-Ghidul <span className="text-blue-500">"Arta Hidratării" </span></p>
            <p className="text-3xl font-bold">(PDF, 10 pagini)</p>
            <p className="lg:text-3xl sm:text-2xl text-2xl font-dancing-script font-bold">Ghidul tău practic pentru a-ți optimiza hidratarea, un element cheie pentru un metabolism sănătos.</p>
            <p className="text-2xl font-dancing-script font-semibold">Valoare: 49 RON</p>
        
        </div>
      </div>

      <div className="bg-[#fbf9f3] border-solid border-1 flex flex-col justify-center my-15  mx-auto lg:p-5">
        <div className="text-center lg:text-3xl text-2xl mt-5">
 ...
 <div className='flex flex-col justify-center items-center mb-4 lg:w-xl mx-auto mt-10'>
        <button  className="font-semibold lg:text-2xl text-xl bg-[#8ecb40ff] shadow-[2px_2px_2px_0_#707070] p-4 transition-all duration-300 ease-out hover:-translate-y-2 shadow-2xl hover:shadow-lg border-2 border-[#8ecb40ff] border-solid mt-5 mb-2 cursor-pointer text-gray-700">Cumpara eBook-ul la doar 49 RON</button>
